 ...
 */
public class MarketByPriceMessageEnricher implements EnricherSpecification {

    private static final Logger log = LoggerFactory.getLogger(MarketByPriceMessageEnricher.class);
