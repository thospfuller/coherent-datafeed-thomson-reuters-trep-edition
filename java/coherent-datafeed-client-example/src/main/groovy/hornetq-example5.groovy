...
Thread.start {
    for (ctr in 0..qty) {
        ...
        TextMessage message = session.createTextMessage("This is text message number ${ctr}.");
...
println "Total time: ${endTime - startTime} to send $receivedCtr messages."