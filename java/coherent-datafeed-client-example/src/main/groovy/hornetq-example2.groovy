...
public class EmbeddedExample
{
   ...
   private static ClientSession coreSession = null;
   ...
   public static void main(final String[] args) {
      try {
          ...
          Queue orderQueue = coreSession.createQueue("OrderQueue", "OrderQueue", true); //HornetQJMSClient.createQueue("OrderQueue");
          ...
          ClientProducer producer = coreSession.createProducer("OrderQueue");
          ClientConsumer consumer = coreSession.createConsumer("OrderQueue");
          
          send (coreSession, producer, "hello world!");

          println "RECEIVED: ${consumer.receive ().getBodyBuffer().readString()}"
   ...
   static void send (ClientSession session, ClientProducer producer, String text) {
       try {
